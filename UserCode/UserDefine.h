...
#define USER_DR_DISTRIBUTION_PARAMETERS 0x11111111  // Only used in case of user defined darate distribution strategy refered to doc that explain this value
